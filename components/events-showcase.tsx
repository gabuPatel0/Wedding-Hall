...
const eventTypes = [
  ...
  image: require("../public/elegant-wedding-ceremony-with-beautiful-decoration.jpg"),
    color: "#f3d5b5",
  },
  {
    icon: Building,
  ...
  image: require("../public/professional-corporate-event-setup-in-elegant-hall.jpg"),
    color: "#e7bc91",
  },
  {
    icon: Cake,
  ...
  image: require("../public/festive-birthday-party-setup-with-decorations.jpg"),
    color: "#d4a276",
  },
  {
    icon: Music,
  ...
  image: require("../public/cultural-event-celebration-with-traditional-decora.jpg"),
    color: "#f3d5b5",
  },
]
