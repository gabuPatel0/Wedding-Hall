...
const eventTypes = [
  ...
  image: require("./elegant-wedding-ceremony-with-beautiful-decoration.jpg"),
    color: "#f3d5b5",
  },
  {
    icon: Building,
  ...
  image: require("./professional-corporate-event-setup-in-elegant-hall.jpg"),
    color: "#e7bc91",
  },
  {
    icon: Cake,
  ...
  image: require("./festive-birthday-party-setup-with-decorations.jpg"),
    color: "#d4a276",
  },
  {
    icon: Music,
  ...
  image: require("./cultural-event-celebration-with-traditional-decora.jpg"),
    color: "#f3d5b5",
  },
]
